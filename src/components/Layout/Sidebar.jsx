...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { icon: Zap, label: 'Orders/KOT', path: '/pos', roles: ['admin', 'branch_head', 'cashier', 'worker'] },
  ...
  return (
    <aside className={`bg-gradient-to-b from-[#0f0f0f] via-[#0a0a0a] to-black h-screen flex flex-col border-r border-white/[0.08] transition-all duration-300 ${
      isCollapsed ? 'w-[80px]' : 'w-[280px]'
    }`}>
      
      <div className="flex flex-col h-full">
        
        <div className={`px-6 py-6 flex items-center ${isCollapsed ? 'justify-center px-4' : 'justify-between'}`}>
          {!isCollapsed && (
          ...
          <button
            ...
            className="p-2 rounded-lg bg-white/[0.05] hover:bg-white/[0.1] border border-white/[0.08] hover:border-white/[0.15] text-gray-400 hover:text-white transition-all duration-200"
              ...
              return (
                <div key={item.path} className="relative">
                  <Link
                    ...
                    className={`group flex items-center ${isCollapsed ? 'justify-center' : 'justify-between'} px-4 py-3 rounded-xl transition-all duration-200 ${
                      isActive
                  ...
                  {isCollapsed && isHovered && (
                    <div className="fixed left-[88px] z-[9999] pointer-events-none" style={{ top: `${index * 58 + 140}px` }}>
        ...
        <div className="p-4 border-t border-white/[0.06]">
          ...
          <button
            ...
            className={`w-full flex items-center ${isCollapsed ? 'justify-center' : 'justify-center'} gap-2 px-4 py-3 bg-white/[0.05] hover:bg-white/[0.1] text-gray-400 hover:text-white rounded-xl transition-all duration-200 text-sm font-semibold border border-white/[0.08] hover:border-white/[0.15] group`}
