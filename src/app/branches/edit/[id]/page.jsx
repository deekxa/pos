...
export default function EditBranchPage() {
  ...
  useEffect(() => {
    ...
    const branch = branches.find(b => b.id === parseInt(params.id))
    ...
    if (branch) {
      ...
      setPoles(branch.poles && branch.poles.length > 0 ? branch.poles : [
  ...
  const handlePoleChange = (index, field, value) => {
    ...
    updatedPoles[index][field] = field === 'count' ? parseInt(value) || 0 : value
                  ...
                  <div key={index} className="grid grid-cols-1 md:grid-cols-4 gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                    <div>
                      ...
                      <input
                        type="text"
                        value={pole.name}
                        onChange={(e) => handlePoleChange(index, 'name', e.target.value)}
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value={pole.head}
                        onChange={(e) => handlePoleChange(index, 'head', e.target.value)}
                        placeholder="Name"
                        className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent bg-white"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        type="number"
                        value={pole.count}
                        onChange={(e) => handlePoleChange(index, 'count', e.target.value)}
                        placeholder="0"
                        min="0"
                        required
                        className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent bg-white"
